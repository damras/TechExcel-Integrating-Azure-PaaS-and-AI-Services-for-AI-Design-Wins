...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get bookings for a hotel starting from a specific date.")]
    ...
    [KernelFunction]
    [Description("Get bookings that are missing hotel room assignments.")]
    ...
    [KernelFunction]
    [Description("Get bookings with multiple hotel rooms assigned.")]
